...
export default function App() {
  ...
  return (
    <div className="flex flex-row items-center justify-center min-h-screen">
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 text-center p-6 flex-auto">
      ...
      <div className="flex flex-col items-center justify-center min-h-screen p-6 flex-auto">
        <div>
